...
type ProductMediaFields_ExternalVideo_Fragment = Pick<
  StorefrontAPI.ExternalVideo,
  'id' | 'embeddedUrl' | 'host' | 'mediaContentType' | 'alt'
>;

type ProductMediaFields_MediaImage_Fragment = Pick<
...
type ProductMediaFields_Model3d_Fragment = Pick<
...
type ProductMediaFields_Video_Fragment = Pick<
  StorefrontAPI.Video,
  'id' | 'mediaContentType' | 'alt'
> & {
  sources: Array<
...
export type ProductMediaFieldsFragment =
  | ProductMediaFields_ExternalVideo_Fragment
  | ProductMediaFields_MediaImage_Fragment
  | ProductMediaFields_Model3d_Fragment
  | ProductMediaFields_Video_Fragment;
